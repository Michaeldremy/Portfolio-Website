        ...
        <div>
            ...
            <section className="title-container">
                ...
                <div className="row">
                    <div className="col-12">
                        <p>
                            Github: <a href="https://github.com/Michaeldremy/Gym_Bro_Python_Project" target="_blank" rel="noopener noreferrer"><GitHubIcon style={{fontSize: '1.8rem', color: 'black'}}></GitHubIcon></a>
                        </p>
                    </div>
                </div>
                </div>
            ...
            <section className="project-details-container">
                ...
                <div className="row">
                    <div className="col-12 detail-points-container">
                        <ul>
                            <li className="detail-points">Workout tracking web app complete with aesthetic landing page, user login/registration 
                            to allow users to select a daily workout comprising of curated exercise sets, 
                            and view a graphical representation of their workout stats.</li>
                            <li className="detail-points">Implemented front and backend validation utilizing HTML, JavaScript, Regex and Bcrypt for hashed passwords to enhance security. </li>
                            <li className="detail-points">Employed RESTful routing with Django and full CRUD functionality for multiple models with SQLite database</li>
                            <li className="detail-points">Demonstrated data visualization of user workout weight averages with Chart It</li>
                            <li className="detail-points">Constructed frontend layout, style and functionality with HTML, CSS, Bootstrap, JQuery and JavaScript</li>
                            <li className="detail-points">Technologies Used: Python, Django, JavaScript, HTML/CSS3, JQuery, ChartIt, Bcrypt, and Regex</li>
                        </ul>
                    </div>
                </div>
            </section>
...
export default GymBroProjectPage;